...
import { Divider, Button, InputText } from "@cadolabs/sphere-ui"

import i18n from "@i18n"

const I18N_PREFIX = "stories.divider"
...
function DividerExample () {
  return (
    <div>
      ...
      <div className="p-card s-container p-3">
        <h3>Vertical with Content</h3>
        <div className="grid">
...
export const divider = {
  ...
  descriptionProps: [
    { name: "align", type: "string", description: `${I18N_PREFIX}.props.align` },
    { name: "layout", type: "string", default: "horizontal", description: `${I18N_PREFIX}.props.layout` },
    { name: "type", type: "string", default: "solid", description: `${I18N_PREFIX}.props.type` },
