...
import { TreeTable, Column, ColumnGroup, Row } from "@cadolabs/sphere-ui"

import i18n, { Trans } from "@i18n"

const I18N_PREFIX = "stories.treetable.pages.colgroup"

const code = `
function ColGroupTreeTableExample () {
  const nodes = [
    {
      key: "0",
...
export const colgroup = {
  ...
  code,
  scope: { TreeTable, Column, ColumnGroup, Row },
}
